...
public class MainPanel extends javax.swing.JPanel {
    ...
    private static class PartitionTableRow {
    ...
    private static class PartitionTableModel extends DefaultTableModel {
    ...
    private void initComponents() {
        ...
        partitionSystemsLabel = new JLabel();
        partitionSystemsBox = new JComboBox<>();
        ...
        partitionSystemsBox.setModel(new DefaultComboBoxModel<>(new String[] {"GUID Partition Table (6 partitions)", "Protective MBR (4 partitions)"}));
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(LEADING)
                        ...
                        .add(layout.createParallelGroup(LEADING)
                                .add(layout.createSequentialGroup()
                                        .addContainerGap()
                                        .add(jScrollPane1, DEFAULT_SIZE, 645, Short.MAX_VALUE)
                                        .addContainerGap()))
        );
                ...
                layout.createParallelGroup(LEADING)
                        .add(layout.createSequentialGroup()
                                ...
                                .add(layout.createParallelGroup(BASELINE)
                                        .add(synchronizeButton)
                                        .add(partitionSystemsBox, PREFERRED_SIZE, DEFAULT_SIZE, PREFERRED_SIZE)
                                        .add(partitionSystemsLabel))
                                .addContainerGap(277, Short.MAX_VALUE))
                        .add(layout.createParallelGroup(LEADING)
                                .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                                        .add(43, 43, 43)
                                        .add(jScrollPane1, DEFAULT_SIZE, 263, Short.MAX_VALUE)
                                        .addContainerGap()))
        );
    ...
    private JComboBox<String> partitionSystemsBox;
