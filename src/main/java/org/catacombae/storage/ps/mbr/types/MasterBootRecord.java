...
public class MasterBootRecord {
    ...
    public byte[] getOptionalIBMExtendedData1() {
        return Util.createCopy(optIBMExtendedData1);
    }

    /** This is an optional field, and might contain unexpected and invalid data. */
    public byte[] getOptionalIBMExtendedData2() {
        return Util.createCopy(optIBMExtendedData2);
    }

    /** This is an optional field, and might contain unexpected and invalid data. */
    public byte[] getOptionalIBMExtendedData3() {
        return Util.createCopy(optIBMExtendedData3);
    }

    /** This is an optional field, and might contain unexpected and invalid data. */
    public byte[] getOptionalIBMExtendedData4() {
        return Util.createCopy(optIBMExtendedData4);
    }
    ...
    public byte[] getBytes() {
        ...
        i += reserved1.length;
        System.arraycopy(optIBMExtendedData1, 0, result, i, optIBMExtendedData1.length);
        i += optIBMExtendedData1.length;
        System.arraycopy(optIBMExtendedData2, 0, result, i, optIBMExtendedData2.length);
        i += optIBMExtendedData2.length;
        System.arraycopy(optIBMExtendedData3, 0, result, i, optIBMExtendedData3.length);
        i += optIBMExtendedData3.length;
        System.arraycopy(optIBMExtendedData4, 0, result, i, optIBMExtendedData4.length);
        i += optIBMExtendedData4.length;
