...
public class ReferenceListEntry implements StaticStruct, PrintableStruct {
    ...
    public void printFields(PrintStream ps, String prefix) {
        ...
        ps.println(prefix + " resourceAttributes: 0x" + Util.toHexStringBE(getResourceAttributes()));
    ...
    public byte[] getBytes() {
        ...
        offset += this.resourceNameOffset.length;
        System.arraycopy(this.resourceAttributes, 0, result, offset, this.resourceAttributes.length);
        offset += this.resourceAttributes.length;
        System.arraycopy(this.resourceDataOffset, 0, result, offset, this.resourceDataOffset.length);
        offset += this.resourceDataOffset.length;
