...
public class DSStoreRootBlock implements DynamicStruct {
    ...
    public void printFields(PrintStream ps, String prefix) {
        ...
        ps.println(prefix + " offsetList: ");
        {
            ...
            for (int _i = 0; _i < this.offsetList.length; ++_i) {
                ps.println(prefix + "   " + _array[_i] + " (0x" + Util.toHexStringBE(_array[_i]) + ")");
            }
        }
    }
    ...
    public int getBytes(byte[] result, int offset) {
        ...
        offset += 4;
        Util.arrayPutBE(result, offset, this.numOffsets);
        offset += 4;
        Util.arrayPutBE(result, offset, this.unknown2);
        offset += 4;
        Util.arrayPutBE(result, offset, this.offsetList);
        offset += 4;
