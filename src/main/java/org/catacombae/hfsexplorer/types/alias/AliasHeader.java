...
public class AliasHeader {
    ...
    public void printFields(PrintStream ps, String prefix) {
        ps.println(prefix + " User type: 0x" + Util.byteArrayToHexString(getUserType()) + " " +
        ...
        ps.println(prefix + " Volume name: " + Util.readString(getVolumeName(), 0, getVolumeNameLength(),
                        "MacRoman"));
        ...
        ps.println(prefix + " Volume filesystem type: " + Util.readString(getVolumeFsType(), "MacRoman"));
        ...
        ps.println(prefix + " File name: " + Util.readString(getFileName(), 0, getFileNameLength(),
                        "MacRoman"));
        ps.println(prefix + " File ID: " + getFileID());
        ps.println(prefix + " File create timestamp: " + HFSPlusDate.gmtTimestampToDate(getRawVolumeCreateTimestamp()) +
                " (" + getFileCreateTimestamp() + ")");
        ps.println(prefix + " File type: " + Util.toASCIIString(getFileType()));
        ps.println(prefix + " File creator: " + Util.toASCIIString(getFileCreator()));
        ps.println(prefix + " Next level up from alias: " + getNextLevelUpFromAlias());
        ps.println(prefix + " Next level down to target: " + getNextLevelDownToTarget());
        ps.println(prefix + " Volume attributes: 0x" + Util.toHexStringBE(getVolumeAttributes()));
        ps.println(prefix + " Filesystem ID: " + getFileSystemID());
        ps.println(prefix + " Reserved: 0x" + Util.byteArrayToHexString(getRawReserved()));
    }
    ...
    public int getBytes(byte[] result, int offset) {
        ...
        offset += 4;
        Util.arrayPutBE(result, offset, this.aliasSize);
        offset += 2;
        Util.arrayPutBE(result, offset, this.version);
        offset += 2;
        Util.arrayPutBE(result, offset, this.flags);
        offset += 2;
        Util.arrayPutBE(result, offset, this.volumeNameLength);
        offset += 1;
        System.arraycopy(this.volumeName, 0, result, offset, this.volumeName.length);
        offset += this.volumeName.length;
        Util.arrayPutBE(result, offset, this.volumeCreateTimestamp);
        offset += 4;
        Util.arrayPutBE(result, offset, this.volumeFsType);
        offset += 2;
        Util.arrayPutBE(result, offset, this.driveType);
        offset += 2;
        Util.arrayPutBE(result, offset, this.parentID);
        offset += 4;
        Util.arrayPutBE(result, offset, this.fileNameLength);
        offset += 1;
        System.arraycopy(this.fileName, 0, result, offset, this.fileName.length);
        offset += this.fileName.length;
        Util.arrayPutBE(result, offset, this.fileID);
        offset += 4;
        Util.arrayPutBE(result, offset, this.fileCreateTimestamp);
        offset += 4;
        Util.arrayPutBE(result, offset, this.fileType);
        offset += 4;
        Util.arrayPutBE(result, offset, this.fileCreator);
        offset += 4;
        Util.arrayPutBE(result, offset, this.nextLevelUpFromAlias);
        offset += 2;
        Util.arrayPutBE(result, offset, this.nextLevelDownToTarget);
        offset += 2;
        Util.arrayPutBE(result, offset, this.volumeAttributes);
        offset += 4;
        Util.arrayPutBE(result, offset, this.fileSystemID);
        offset += 2;
