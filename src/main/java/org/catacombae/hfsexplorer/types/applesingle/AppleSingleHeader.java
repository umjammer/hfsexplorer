...
public class AppleSingleHeader {
    ...
    public int getMagicNumber() {
        return Util.readIntBE(magicNumber);
    }

    /** */
    public int getVersionNumber() {
        return Util.readIntBE(versionNumber);
    }

    /** */
    public byte[] getHomeFileSystem() {
        return Util.readByteArrayBE(homeFileSystem);
    }

    /** */
    public short getNumEntries() {
        return Util.readShortBE(numEntries);
    }
    ...
    public byte[] getBytes() {
        ...
        int offset = 0;
        System.arraycopy(magicNumber, 0, result, offset, magicNumber.length);
        offset += magicNumber.length;
        System.arraycopy(versionNumber, 0, result, offset, versionNumber.length);
        offset += versionNumber.length;
        System.arraycopy(homeFileSystem, 0, result, offset, homeFileSystem.length);
        offset += homeFileSystem.length;
        System.arraycopy(numEntries, 0, result, offset, numEntries.length);
        offset += numEntries.length;
        return result;
    }
}
