...
public abstract class CommonExtendedFinderInfo implements StructElements, PrintableStruct {
    ...
    public short getExtendedFinderFlags() {
        return Util.readShortBE(extendedFinderFlags);
    }
    ...
    public int getPutAwayFolderID() {
        return Util.readIntBE(putAwayFolderID);
    }
    ...
    public void printFields(PrintStream ps, String prefix) {
        ...
        ps.println(prefix + " reserved2: 0x" + Util.toHexStringBE(getReserved2()));
    ...
    public Dictionary getStructElements() {
        ...
        db.add("extendedFinderFlags", extendedFinderFlagsDict, "Extended Finder flags");
        db.addUIntBE("reserved2", reserved2, "Reserved", IntegerFieldRepresentation.HEXADECIMAL);
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(extendedFinderFlags, 0, result, offset, extendedFinderFlags.length);
        offset += extendedFinderFlags.length;
        System.arraycopy(reserved2, 0, result, offset, reserved2.length);
        offset += reserved2.length;
        System.arraycopy(putAwayFolderID, 0, result, offset, putAwayFolderID.length);
        offset += putAwayFolderID.length;
