...
public abstract class CommonFinderInfo implements StructElements, PrintableStruct {
    ...
    public short getFinderFlags() {
        return Util.readShortBE(finderFlags);
    }
    ...
    public boolean getFinderFlagIsShared() {
        return (getFinderFlags() & kIsShared) != 0;
    }

    public boolean getFinderFlagHasNoINITs() {
        return (getFinderFlags() & kHasNoINITs) != 0;
    }

    public boolean getFinderFlagHasBeenInited() {
        return (getFinderFlags() & kHasBeenInited) != 0;
    }

    public boolean getFinderFlagHasCustomIcon() {
        return (getFinderFlags() & kHasCustomIcon) != 0;
    }

    public boolean getFinderFlagIsStationery() {
        return (getFinderFlags() & kIsStationery) != 0;
    }

    public boolean getFinderFlagNameLocked() {
        return (getFinderFlags() & kNameLocked) != 0;
    }

    public boolean getFinderFlagHasBundle() {
        return (getFinderFlags() & kHasBundle) != 0;
    }

    public boolean getFinderFlagIsInvisible() {
        return (getFinderFlags() & kIsInvisible) != 0;
    }

    public boolean getFinderFlagIsAlias() {
        return (getFinderFlags() & kIsAlias) != 0;
    }
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(finderFlags, 0, result, offset, finderFlags.length);
        offset += finderFlags.length;
        tempData = location.getBytes();
        System.arraycopy(tempData, 0, result, offset, tempData.length);
        offset += tempData.length;
        System.arraycopy(reservedField, 0, result, offset, reservedField.length);
        offset += reservedField.length;
    ...
    public void printFields(PrintStream ps, String prefix) {
        ...
        ps.println(prefix + "  kColor: 0x" + Util.toHexStringBE(getFinderFlagColor()));
        ps.println(prefix + "  kIsShared: " + (getFinderFlagIsShared() ? "1" : "0"));
        ps.println(prefix + "  kHasNoINITs: " + (getFinderFlagHasNoINITs() ? "1" : "0"));
        ps.println(prefix + "  kHasBeenInited: " + (getFinderFlagHasBeenInited() ? "1" : "0"));
        ps.println(prefix + "  kHasCustomIcon: " + (getFinderFlagHasCustomIcon() ? "1" : "0"));
        ps.println(prefix + "  kIsStationery: " + (getFinderFlagIsStationery() ? "1" : "0"));
        ps.println(prefix + "  kNameLocked: " + (getFinderFlagNameLocked() ? "1" : "0"));
        ps.println(prefix + "  kHasBundle: " + (getFinderFlagHasBundle() ? "1" : "0"));
        ps.println(prefix + "  kIsInvisible: " + (getFinderFlagIsInvisible() ? "1" : "0"));
        ps.println(prefix + "  kIsAlias: " + (getFinderFlagIsAlias() ? "1" : "0"));
