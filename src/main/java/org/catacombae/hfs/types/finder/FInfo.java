...
public class FInfo implements PrintableStruct, StructElements {
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(this.fdFlags, 0, result, offset, this.fdFlags.length);
        offset += this.fdFlags.length;
        {
            byte[] tempData = this.fdLocation.getBytes();
            System.arraycopy(tempData, 0, result, offset, tempData.length);
            offset += tempData.length;
        }
        System.arraycopy(this.fdFldr, 0, result, offset, this.fdFldr.length);
