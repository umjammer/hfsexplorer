...
public class CdrDirRec extends CatDataRec {
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(dirFlags, 0, result, offset, dirFlags.length);
        offset += dirFlags.length;
        System.arraycopy(dirVal, 0, result, offset, dirVal.length);
        offset += dirVal.length;
        System.arraycopy(dirDirID, 0, result, offset, dirDirID.length);
        offset += dirDirID.length;
        System.arraycopy(dirCrDat, 0, result, offset, dirCrDat.length);
        offset += dirCrDat.length;
        System.arraycopy(dirMdDat, 0, result, offset, dirMdDat.length);
        offset += dirMdDat.length;
        System.arraycopy(dirBkDat, 0, result, offset, dirBkDat.length);
        offset += dirBkDat.length;
        ...
        System.arraycopy(tempData, 0, result, offset, tempData.length);
        offset += tempData.length;
        System.arraycopy(dirResrv, 0, result, offset, dirResrv.length);
        offset += dirResrv.length;
        return result;
    }
