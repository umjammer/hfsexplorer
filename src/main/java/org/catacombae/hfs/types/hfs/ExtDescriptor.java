...
public class ExtDescriptor implements PrintableStruct, StructElements {
    ...
    public byte[] getBytes() {
        ...
        byte[] tempData;
        int offset = 0;
        System.arraycopy(xdrStABN, 0, result, offset, xdrStABN.length);
        offset += xdrStABN.length;
        System.arraycopy(xdrNumABlks, 0, result, offset, xdrNumABlks.length);
        offset += xdrNumABlks.length;
        return result;
    }
