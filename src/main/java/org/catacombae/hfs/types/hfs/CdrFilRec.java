...
public class CdrFilRec extends CatDataRec {
    ...
    public byte getFilFlags() {
        return Util.readByteBE(filFlags);
    }

    /** file type (SignedByte) */
    public byte getFilTyp() {
        return Util.readByteBE(filTyp);
    }
    ...
    public short getFilClpSize() {
        return Util.readShortBE(filClpSize);
    }
    ...
    public int getFilResrv() {
        return Util.readIntBE(filResrv);
    }
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(filFlags, 0, result, offset, filFlags.length);
        offset += filFlags.length;
        System.arraycopy(filTyp, 0, result, offset, filTyp.length);
        offset += filTyp.length;
        tempData = filUsrWds.getBytes();
        System.arraycopy(tempData, 0, result, offset, tempData.length);
        offset += tempData.length;
        System.arraycopy(filFlNum, 0, result, offset, filFlNum.length);
        offset += filFlNum.length;
        System.arraycopy(filStBlk, 0, result, offset, filStBlk.length);
        offset += filStBlk.length;
        System.arraycopy(filLgLen, 0, result, offset, filLgLen.length);
        offset += filLgLen.length;
        System.arraycopy(filPyLen, 0, result, offset, filPyLen.length);
        offset += filPyLen.length;
        System.arraycopy(filRStBlk, 0, result, offset, filRStBlk.length);
        offset += filRStBlk.length;
        System.arraycopy(filRLgLen, 0, result, offset, filRLgLen.length);
        offset += filRLgLen.length;
        System.arraycopy(filRPyLen, 0, result, offset, filRPyLen.length);
        offset += filRPyLen.length;
        System.arraycopy(filCrDat, 0, result, offset, filCrDat.length);
        offset += filCrDat.length;
        System.arraycopy(filMdDat, 0, result, offset, filMdDat.length);
        offset += filMdDat.length;
        System.arraycopy(filBkDat, 0, result, offset, filBkDat.length);
        offset += filBkDat.length;
        tempData = filFndrInfo.getBytes();
        System.arraycopy(tempData, 0, result, offset, tempData.length);
        offset += tempData.length;
        System.arraycopy(filClpSize, 0, result, offset, filClpSize.length);
        offset += filClpSize.length;
        ...
        System.arraycopy(tempData, 0, result, offset, tempData.length);
        offset += tempData.length;
        System.arraycopy(filResrv, 0, result, offset, filResrv.length);
        offset += filResrv.length;
        return result;
    }
