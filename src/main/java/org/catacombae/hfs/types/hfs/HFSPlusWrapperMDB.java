...
public class HFSPlusWrapperMDB implements PrintableStruct {
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(drFndrInfo, 0, result, offset, drFndrInfo.length);
        offset += drFndrInfo.length;
        System.arraycopy(drEmbedSigWord, 0, result, offset, drEmbedSigWord.length);
        offset += drEmbedSigWord.length;
