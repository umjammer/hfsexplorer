...
public class MasterDirectoryBlock implements PrintableStruct, StructElements {
    ...
    public int getDrCTFlSize() {
        return Util.readIntBE(drCTFlSize);
    }
    ...
    public byte[] getBytes() {
        ...
        byte[] tempData;
        int offset = 0;
        System.arraycopy(drSigWord, 0, result, offset, drSigWord.length);
        offset += drSigWord.length;
        System.arraycopy(drCrDate, 0, result, offset, drCrDate.length);
        offset += drCrDate.length;
        System.arraycopy(drLsMod, 0, result, offset, drLsMod.length);
        offset += drLsMod.length;
        System.arraycopy(drAtrb, 0, result, offset, drAtrb.length);
        offset += drAtrb.length;
        System.arraycopy(drNmFls, 0, result, offset, drNmFls.length);
        offset += drNmFls.length;
        System.arraycopy(drVBMSt, 0, result, offset, drVBMSt.length);
        offset += drVBMSt.length;
        System.arraycopy(drAllocPtr, 0, result, offset, drAllocPtr.length);
        offset += drAllocPtr.length;
        System.arraycopy(drNmAlBlks, 0, result, offset, drNmAlBlks.length);
        offset += drNmAlBlks.length;
        System.arraycopy(drAlBlkSiz, 0, result, offset, drAlBlkSiz.length);
        offset += drAlBlkSiz.length;
        System.arraycopy(drClpSiz, 0, result, offset, drClpSiz.length);
        offset += drClpSiz.length;
        System.arraycopy(drAlBlSt, 0, result, offset, drAlBlSt.length);
        offset += drAlBlSt.length;
        System.arraycopy(drNxtCNID, 0, result, offset, drNxtCNID.length);
        offset += drNxtCNID.length;
        System.arraycopy(drFreeBks, 0, result, offset, drFreeBks.length);
        offset += drFreeBks.length;
        System.arraycopy(drVNLength, 0, result, offset, drVNLength.length);
        offset += drVNLength.length;
        System.arraycopy(drVN, 0, result, offset, drVN.length);
        offset += drVN.length;
        System.arraycopy(drVolBkUp, 0, result, offset, drVolBkUp.length);
        offset += drVolBkUp.length;
        System.arraycopy(drVSeqNum, 0, result, offset, drVSeqNum.length);
        offset += drVSeqNum.length;
        System.arraycopy(drWrCnt, 0, result, offset, drWrCnt.length);
        offset += drWrCnt.length;
        System.arraycopy(drXTClpSiz, 0, result, offset, drXTClpSiz.length);
        offset += drXTClpSiz.length;
        System.arraycopy(drCTClpSiz, 0, result, offset, drCTClpSiz.length);
        offset += drCTClpSiz.length;
        System.arraycopy(drNmRtDirs, 0, result, offset, drNmRtDirs.length);
        offset += drNmRtDirs.length;
        System.arraycopy(drFilCnt, 0, result, offset, drFilCnt.length);
        offset += drFilCnt.length;
        System.arraycopy(drDirCnt, 0, result, offset, drDirCnt.length);
        offset += drDirCnt.length;
        offset += drFndrInfo.getBytes(result, offset);
        System.arraycopy(drVCSize, 0, result, offset, drVCSize.length);
        offset += drVCSize.length;
        System.arraycopy(drVBMCSize, 0, result, offset, drVBMCSize.length);
        offset += drVBMCSize.length;
        System.arraycopy(drCtlCSize, 0, result, offset, drCtlCSize.length);
        offset += drCtlCSize.length;
        System.arraycopy(drXTFlSize, 0, result, offset, drXTFlSize.length);
        offset += drXTFlSize.length;
        tempData = drXTExtRec.getBytes();
        System.arraycopy(tempData, 0, result, offset, tempData.length);
        offset += tempData.length;
        System.arraycopy(drCTFlSize, 0, result, offset, drCTFlSize.length);
        offset += drCTFlSize.length;
