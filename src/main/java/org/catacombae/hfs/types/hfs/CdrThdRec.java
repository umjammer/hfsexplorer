...
public class CdrThdRec extends CatDataRec {
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(thdResrv, 0, result, offset, thdResrv.length);
        offset += thdResrv.length;
        System.arraycopy(thdParID, 0, result, offset, thdParID.length);
        offset += thdParID.length;
        System.arraycopy(thdCNameLen, 0, result, offset, thdCNameLen.length);
        offset += thdCNameLen.length;
        System.arraycopy(thdCName, 0, result, offset, thdCName.length);
