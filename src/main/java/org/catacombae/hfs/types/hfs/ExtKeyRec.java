...
public class ExtKeyRec implements PrintableStruct, StructElements {
    ...
    public byte getXkrKeyLen() {
        return Util.readByteBE(xkrKeyLen);
    }

    /** fork type (SignedByte) */
    public byte getXkrFkType() {
        return Util.readByteBE(xkrFkType);
    }

    /** file number (LongInt) */
    public int getXkrFNum() {
        return Util.readIntBE(xkrFNum);
    }
    ...
    public byte[] getBytes() {
        ...
        int offset = 0;
        System.arraycopy(xkrKeyLen, 0, result, offset, xkrKeyLen.length);
        offset += xkrKeyLen.length;
        System.arraycopy(xkrFkType, 0, result, offset, xkrFkType.length);
        offset += xkrFkType.length;
        System.arraycopy(xkrFNum, 0, result, offset, xkrFNum.length);
        offset += xkrFNum.length;
        System.arraycopy(xkrFABN, 0, result, offset, xkrFABN.length);
        offset += xkrFABN.length;
        return result;
    }
