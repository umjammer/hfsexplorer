...
public class BootBlkHdr implements PrintableStruct {
    ...
    public byte[] getBytes() {
        ...
        int offset = 0;
        System.arraycopy(bbID, 0, result, offset, bbID.length);
        offset += bbID.length;
        System.arraycopy(bbEntry, 0, result, offset, bbEntry.length);
        offset += bbEntry.length;
        System.arraycopy(bbVersion, 0, result, offset, bbVersion.length);
        offset += bbVersion.length;
        System.arraycopy(bbPageFlags, 0, result, offset, bbPageFlags.length);
        offset += bbPageFlags.length;
        System.arraycopy(bbSysName, 0, result, offset, bbSysName.length);
        offset += bbSysName.length;
        System.arraycopy(bbShellName, 0, result, offset, bbShellName.length);
        offset += bbShellName.length;
        System.arraycopy(bbDbg1Name, 0, result, offset, bbDbg1Name.length);
        offset += bbDbg1Name.length;
        System.arraycopy(bbDbg2Name, 0, result, offset, bbDbg2Name.length);
        offset += bbDbg2Name.length;
        System.arraycopy(bbScreenName, 0, result, offset, bbScreenName.length);
        offset += bbScreenName.length;
        System.arraycopy(bbHelloName, 0, result, offset, bbHelloName.length);
        offset += bbHelloName.length;
        System.arraycopy(bbScrapName, 0, result, offset, bbScrapName.length);
        offset += bbScrapName.length;
        System.arraycopy(bbCntFCBs, 0, result, offset, bbCntFCBs.length);
        offset += bbCntFCBs.length;
        System.arraycopy(bbCntEvts, 0, result, offset, bbCntEvts.length);
        offset += bbCntEvts.length;
        System.arraycopy(bb128KSHeap, 0, result, offset, bb128KSHeap.length);
        offset += bb128KSHeap.length;
        System.arraycopy(bb256KSHeap, 0, result, offset, bb256KSHeap.length);
        offset += bb256KSHeap.length;
        System.arraycopy(bbSysHeapSize, 0, result, offset, bbSysHeapSize.length);
        offset += bbSysHeapSize.length;
        System.arraycopy(filler, 0, result, offset, filler.length);
        offset += filler.length;
        System.arraycopy(bbSysHeapExtra, 0, result, offset, bbSysHeapExtra.length);
        offset += bbSysHeapExtra.length;
        System.arraycopy(bbSysHeapFract, 0, result, offset, bbSysHeapFract.length);
        offset += bbSysHeapFract.length;
        return result;
    }
}
