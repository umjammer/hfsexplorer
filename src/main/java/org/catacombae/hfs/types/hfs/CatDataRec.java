...
public abstract class CatDataRec implements StaticStruct, PrintableStruct, StructElements {
    ...
    public byte getCdrType() {
        return Util.readByteBE(cdrType);
    }
    ...
    public byte[] getBytes() {
        ...
        int offset = 0;
        System.arraycopy(cdrType, 0, result, offset, cdrType.length);
        offset += cdrType.length;
        System.arraycopy(cdrResrv2, 0, result, offset, cdrResrv2.length);
        offset += cdrResrv2.length;
        return result;
    }
