...
public class BTHeaderRec implements PrintableStruct, StructElements {
    ...
    public short getTreeDepth() {
        return Util.readShortBE(treeDepth);
    }

    public int getRootNode() {
        return Util.readIntBE(rootNode);
    }

    public int getLeafRecords() {
        return Util.readIntBE(leafRecords);
    }

    public int getFirstLeafNode() {
        return Util.readIntBE(firstLeafNode);
    }

    public int getLastLeafNode() {
        return Util.readIntBE(lastLeafNode);
    }

    public short getNodeSize() {
        return Util.readShortBE(nodeSize);
    }

    public short getMaxKeyLength() {
        return Util.readShortBE(maxKeyLength);
    }

    public int getTotalNodes() {
        return Util.readIntBE(totalNodes);
    }

    public int getFreeNodes() {
        return Util.readIntBE(freeNodes);
    }
    ...
    public byte getBtreeType() {
        return Util.readByteBE(btreeType);
    }
    ...
    public byte getKeyCompareType() {
        return Util.readByteBE(keyCompareType);
    }
    ...
    public int[] getReserved3() {
        return Util.readIntArrayBE(reserved3);
    }
    ...
    public byte[] getBytes() {
        ...
        System.arraycopy(treeDepth, 0, result, offset, treeDepth.length);
        offset += treeDepth.length;
        System.arraycopy(rootNode, 0, result, offset, rootNode.length);
        offset += rootNode.length;
        System.arraycopy(leafRecords, 0, result, offset, leafRecords.length);
        offset += leafRecords.length;
        System.arraycopy(firstLeafNode, 0, result, offset, firstLeafNode.length);
        offset += firstLeafNode.length;
        System.arraycopy(lastLeafNode, 0, result, offset, lastLeafNode.length);
        offset += lastLeafNode.length;
        System.arraycopy(nodeSize, 0, result, offset, nodeSize.length);
        offset += nodeSize.length;
        System.arraycopy(maxKeyLength, 0, result, offset, maxKeyLength.length);
        offset += maxKeyLength.length;
        System.arraycopy(totalNodes, 0, result, offset, totalNodes.length);
        offset += totalNodes.length;
        System.arraycopy(freeNodes, 0, result, offset, freeNodes.length);
        offset += freeNodes.length;
        ...
        System.arraycopy(btreeType, 0, result, offset, btreeType.length);
        offset += btreeType.length;
        System.arraycopy(keyCompareType, 0, result, offset, keyCompareType.length);
        offset += keyCompareType.length;
        System.arraycopy(attributes, 0, result, offset, attributes.length);
        offset += attributes.length;
        System.arraycopy(reserved3, 0, result, offset, reserved3.length);
    ...
    public Dictionary getStructElements() {
        ...
        attributesDict.addFlag("kBTBadClose", attributes, 0, "B-tree was not closed properly");
        attributesDict.addFlag("kBTBigKeys", attributes, 1, "B-tree uses big keys");
