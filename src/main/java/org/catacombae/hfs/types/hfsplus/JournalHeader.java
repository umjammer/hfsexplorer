...
public class JournalHeader implements StaticStruct, PrintableStruct, StructElements {
    ...
    public JournalHeader(byte[] data, int offset) {
        ...
        if (magic == JOURNAL_HEADER_MAGIC_BE && endian == ENDIAN_MAGIC_BE) {
            ...
            throw new RuntimeException("Unrecognized magic '0x" + Util.toHexStringBE(magic) + "'.");
        }
    }
    ...
    public byte[] getBytes() {
        ...
        if (!littleEndian) {
            Util.arrayPutBE(result, offset, magic);
            offset += 4;
            Util.arrayPutBE(result, offset, endian);
            offset += 4;
            Util.arrayPutBE(result, offset, start);
            offset += 8;
            Util.arrayPutBE(result, offset, end);
            offset += 8;
            Util.arrayPutBE(result, offset, size);
            offset += 8;
            Util.arrayPutBE(result, offset, blhdrSize);
            offset += 4;
            Util.arrayPutBE(result, offset, checksum);
            offset += 4;
            Util.arrayPutBE(result, offset, jhdrSize);
            offset += 4;
        } else {
            Util.arrayPutLE(result, offset, magic);
            offset += 4;
            Util.arrayPutLE(result, offset, endian);
            offset += 4;
            Util.arrayPutLE(result, offset, start);
            offset += 8;
            Util.arrayPutLE(result, offset, end);
            offset += 8;
            Util.arrayPutLE(result, offset, size);
            offset += 8;
            Util.arrayPutLE(result, offset, blhdrSize);
            offset += 4;
            Util.arrayPutLE(result, offset, checksum);
            offset += 4;
            Util.arrayPutLE(result, offset, jhdrSize);
            offset += 4;
        }
