...
public class BlockInfo implements StaticStruct, PrintableStruct {
    ...
    public int getBytes(byte[] result, int offset) {
        ...
        if (!littleEndian) {
            ...
            offset += 8;
            Util.arrayPutBE(result, offset, bsize);
            offset += 4;
            Util.arrayPutBE(result, offset, next);
            offset += 4;
        } else {
            Util.arrayPutLE(result, offset, bnum);
            offset += 8;
            Util.arrayPutLE(result, offset, bsize);
            offset += 4;
            Util.arrayPutLE(result, offset, next);
            offset += 4;
        }
