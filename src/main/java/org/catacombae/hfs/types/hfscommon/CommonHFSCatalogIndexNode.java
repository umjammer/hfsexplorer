...
public abstract class CommonHFSCatalogIndexNode extends CommonBTKeyedNode<CommonBTIndexRecord<CommonHFSCatalogKey>> {
    ...
    protected CommonHFSCatalogIndexNode(byte[] data, int offset, int nodeSize, FSType type) {
    ...
    public static CommonHFSCatalogIndexNode createHFSX(byte[] data, int offset, int nodeSize, byte keyCompareType) {
